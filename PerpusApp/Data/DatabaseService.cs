...
namespace PerpusApp.Data
{
    ...
    {
        private readonly DatabaseConnectionSingleton _connectionSingleton;

        public DatabaseService(string connectionString)
        {
            // Menggunakan Singleton Pattern untuk koneksi database
            _connectionSingleton = DatabaseConnectionSingleton.GetInstance(connectionString);
        }

        public async Task<bool> TestConnectionAsync()
        {
            return await _connectionSingleton.TestConnectionAsync();
        }
